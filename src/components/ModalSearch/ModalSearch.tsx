...
import { Search, ArrowBack, Add, AccessTime, AttachMoney } from '@mui/icons-material';
      ...
      >
        ...
        >
          <Tab
            ...
            sx={{
              width: '50%',
              background: activeTab === 'tests' ? 'linear-gradient(to right, #006400, #228B22)' : 'lightgrey',
          ...
          <Tab
            ...
            sx={{
              width: '50%',
              background: activeTab === 'checkups' ? 'linear-gradient(to right, #006400, #228B22)' : 'lightgrey',
        ...
        <Box sx={{ mt: 2, height: '300px', overflowY: 'auto' }}>
          <Typography variant="h6" sx={{ mb: 2 }}>
            {activeTab === 'tests' ? 'Frequently Booked Tests' : 'Frequently Booked Checkups'}
          </Typography>
          ...
          {cards.map((card, index) => (
            ...
            >
              ...
              <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 1 }}>
                ...
                <Button variant="outlined" startIcon={<Add />} sx={{ borderColor: '#006400', color: '#006400' }}>
                  Add
                </Button>
              </Box>
              ...
              <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 1 }}>
                ...
                <Box>
                  <Typography
                    variant="body2"
                    sx={{ textDecoration: 'line-through', color: 'grey', mr: 1 }}
                  >
                    ₹{card.priceOld}
                  </Typography>
              ...
              {/* Also Known As */}
              <Box sx={{ borderTop: '2px dashed lightgrey', borderBottom: '2px dashed lightgrey', py: 1, mb: 1 }}>
                <Typography variant="body2" sx={{ fontStyle: 'italic', color: 'orange', mb: 1 }}>
                  Also known as
                </Typography>
                <Typography
                  variant="body2"
                  sx={{ fontStyle: 'italic', color: 'grey', borderLeft: '1px solid lightgrey', pl: 1 }}
                >
                  {card.alsoKnownAs}
                </Typography>
              </Box>
